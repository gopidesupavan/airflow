...
with DAG(
    dag_id="example_short_circuit_operator_debug",
    schedule=None,
    ...
    cond_true1 = PythonSensor(
        task_id="cond_true1",
        python_callable=lambda: True,
    )
    cond_true2 = PythonSensor(
        task_id="python_sensor_callble2",
        python_callable=lambda: True,
    )
    cond_false >> [cond_true1, cond_true2]
