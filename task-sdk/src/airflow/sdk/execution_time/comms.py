...
class DagCountResult(DagCountResponse):
    type: Literal["DagCountResult"] = "DagCountResult"

    @classmethod
    def from_api_response(cls, dag_count_response: DagCountResponse) -> DagCountResult:
        """
        Create result class from API Response.
        ...
        discriminator field.
        """
        return cls(**dag_count_response.model_dump(exclude_defaults=True), type="DagCountResult")
...
class GetDagCountByRunIdsAndStates(BaseModel):
    dag_id: str
    run_ids: list[str]
    states: list[str]
    type: Literal["GetDagCountByRunIdsAndStates"] = "GetDagCountByRunIdsAndStates"
